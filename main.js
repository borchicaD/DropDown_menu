...
xml.open('GET', 'https://raw.githubusercontent.com/borchicaD/json_menu/main/json_my.json');
xml.onreadystatechange = function() {
  if (xml.readyState == 4 && xml.status == 200) {
    //got the data
    document.getElementById('mainDiv').innerHTML = display(JSON.parse(xml.responseText), "main")
    setClicks()
  }
}
